...
class InputElement:
    ...
    def show_properties(self):
        ...
        if color is not None:
            ...
            self.canvas.itemconfig(self.representation, fill=color)
...
class Connection:
    def __init__(self, canvas, start, end):
        ...
        self.start = start
        self.end = end
        self.representation = self.canvas.create_line(start[0], start[1], end[0], end[1], fill="black")
